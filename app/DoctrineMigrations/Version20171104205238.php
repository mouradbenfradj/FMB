 ...
 */
class Version20171104205238 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE articles DROP FOREIGN KEY FK_BFDD3168B960C52B');
        $this->addSql('ALTER TABLE articles CHANGE id_valo id_valo SMALLINT NOT NULL, CHANGE ref_art_categ ref_art_categ VARCHAR(32) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE articles CHANGE ref_art_categ ref_art_categ VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE id_valo id_valo SMALLINT DEFAULT NULL');
        $this->addSql('ALTER TABLE articles ADD CONSTRAINT FK_BFDD3168B960C52B FOREIGN KEY (id_valo) REFERENCES articles_valorisations (id_valo)');
        $this->addSql('ALTER TABLE pdf_types CHANGE id_pdf_type id_pdf_type TINYINT(1) NOT NULL');
