 ...
 */
final class Version20230929171352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Parc (id INT AUTO_INCREMENT NOT NULL, id_magasin SMALLINT NOT NULL, lib_parc VARCHAR(64) NOT NULL, abrev_parc VARCHAR(32) NOT NULL, UNIQUE INDEX UNIQ_6AEE5A3F8A32F657 (id_magasin), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
