...
use App\Repository\Asc\Alerte\AlerteVertRepository;
use Doctrine\ORM\Mapping as ORM;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;

/**
 * @ORM\Entity(repositoryClass=AlerteVertRepository::class)
 */
class AlerteVert  extends Alerte
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=Cycle::class, mappedBy="alerteVert")
     */
    private $cycles;
