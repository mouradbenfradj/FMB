...
class PreparationsCordeType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $formModifier = function (FormInterface $form, ?Collection $cordes = null) {
            $quantiter = null === $cordes ? [] : $cordes->first()->getQuantiter();
        ...
        $builder->addEventListener(
            ...
            function (FormEvent $event) use ($formModifier) {
                ...
                $formModifier($event->getForm(), $data->getCordes());
            }
        );
    }
