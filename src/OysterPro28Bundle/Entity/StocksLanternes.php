 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="OysterPro28Bundle\Repository\StocksLanternesRepository")
 */
class StocksLanternes
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="OysterPro28Bundle\Entity\Lanterne", inversedBy="stockslanternes",cascade={"persist"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="OysterPro28Bundle\Entity\Poche", mappedBy="stocklanterne",cascade={"persist","remove"},fetch="LAZY")
     */
    private $poches;
     ...
     * Get lanterne
     *
     * @return \OysterPro28Bundle\Entity\Lanterne
     */
     ...
     * Set lanterne
     *
     * @param \OysterPro28Bundle\Entity\Lanterne $lanterne
     * @return StocksLanternes
     */
    public function setLanterne(\OysterPro28Bundle\Entity\Lanterne $lanterne)
    {
     ...
     * Add poches
     *
     * @param \OysterPro28Bundle\Entity\Poche $poches
     * @return StocksLanternes
     */
    public function addPoch(\OysterPro28Bundle\Entity\Poche $poches)
    {
        $this->poches[] = $poches;
     ...
     * @param \OysterPro28Bundle\Entity\Poche $poches
     */
    public function removePoch(\OysterPro28Bundle\Entity\Poche $poches)
    {
