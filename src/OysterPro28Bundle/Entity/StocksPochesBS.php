 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="OysterPro28Bundle\Repository\StocksPochesBSRepository")
 */
class StocksPochesBS
{
    ...
    private $id;
    /**
     * @ORM\ManyToOne(targetEntity="OysterPro28Bundle\Entity\PochesBS", inversedBy="stockspoches",cascade={"persist"})
    ...
    /**
     * @ORM\OneToOne(targetEntity="OysterPro28Bundle\Entity\Emplacement", mappedBy="stockspoches")
     * @ORM\JoinColumn(nullable=true)
     */
    private $emplacement;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="OysterPro28Bundle\Entity\StocksCordes", inversedBy="pocheAssemblage")
     * @ORM\JoinColumn(nullable=true)
     */
     ...
     * Set pochesbs
     *
     * @param \OysterPro28Bundle\Entity\PochesBS $pochesbs
     * @return StocksPochesBS
     */
    public function setPochesbs(\OysterPro28Bundle\Entity\PochesBS $pochesbs)
    {
     ...
     * Get pochesbs
     *
     * @return \OysterPro28Bundle\Entity\PochesBS
     */
     ...
     * Set cordeAssemblage
     *
     * @param \OysterPro28Bundle\Entity\StocksCordes $cordeAssemblage
     * @return StocksPochesBS
     */
    public function setCordeAssemblage(\OysterPro28Bundle\Entity\StocksCordes $cordeAssemblage = null)
    {
     ...
     * Get cordeAssemblage
     *
     * @return \OysterPro28Bundle\Entity\StocksCordes
     */
