 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="OysterPro28Bundle\Repository\ProcessusRepository")
 * @UniqueEntity(
...
class Processus
{
    ...
    private $id;
    /**
     * @var \OysterPro28Bundle\Entity\Processus
     *
     * @ORM\ManyToOne(targetEntity="OysterPro28Bundle\Entity\Processus", inversedBy="idProcessusSuivant",fetch="LAZY")
     */
    private $idProcessusParent;
    /**
     * @var \OysterPro28Bundle\Entity\Processus
     *
     * @ORM\OneToOne(targetEntity="OysterPro28Bundle\Entity\Processus", mappedBy="idProcessusParent",fetch="LAZY")
     */
     ...
     *
     * @ORM\ManyToOne(targetEntity="OysterPro28Bundle\Entity\Articles")
     * @ORM\JoinColumn(name="ref_article", referencedColumnName="ref_article", nullable=false)
     */
    private $articleDebut;
    /**
     * @var \OysterPro28Bundle\Entity\Phases
     *
     * @ORM\ManyToOne(targetEntity="OysterPro28Bundle\Entity\Phases")
     ...
     * Set articleDebut
     *
     * @param \OysterPro28Bundle\Entity\Articles $articleDebut
     * @return Processus
     */
    public function setArticleDebut(\OysterPro28Bundle\Entity\Articles $articleDebut = null)
    {
     ...
     * Set phasesProcessus
     *
     * @param \OysterPro28Bundle\Entity\Phases $phasesProcessus
     * @return Processus
     */
    public function setPhasesProcessus(\OysterPro28Bundle\Entity\Phases $phasesProcessus = null)
    {
     ...
     * Get phasesProcessus
     *
     * @return \OysterPro28Bundle\Entity\Phases
     */
     ...
     *
     * @param \OysterPro28Bundle\Entity\Processus $idProcessusParent
     * @return Processus
     */
    public function setIdProcessusParent(\OysterPro28Bundle\Entity\Processus $idProcessusParent = null)
    {
     ...
     *
     * @param \OysterPro28Bundle\Entity\Processus $idProcessusSuivant
     * @return Processus
     */
    public function setIdProcessusSuivant(\OysterPro28Bundle\Entity\Processus $idProcessusSuivant = null)
    {
