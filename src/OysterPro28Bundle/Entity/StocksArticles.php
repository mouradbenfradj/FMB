...
class StocksArticles
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="OysterPro28Bundle\Entity\StocksArticlesSn", mappedBy="refStockArticle" ,cascade={"persist","remove"})
     */
     ...
     * @return StocksArticles
     */
    public function setRefArticle(\OysterPro28Bundle\Entity\Articles $refArticle = null)
    {
     ...
     * Set idStock
     *
     * @param \OysterPro28Bundle\Entity\Stocks $idStock
     * @return StocksArticles
     */
    public function setIdStock(\OysterPro28Bundle\Entity\Stocks $idStock = null)
    {
     ...
     * Get idStock
     *
     * @return \OysterPro28Bundle\Entity\Stocks
     */
     ...
     *
     * @param \OysterPro28Bundle\Entity\StocksArticlesSn $stocksArticlesSn
     * @return StocksArticles
     */
    public function addStocksArticlesSn(\OysterPro28Bundle\Entity\StocksArticlesSn $stocksArticlesSn)
    {
     ...
     * @param \OysterPro28Bundle\Entity\StocksArticlesSn $stocksArticlesSn
     */
    public function removeStocksArticlesSn(\OysterPro28Bundle\Entity\StocksArticlesSn $stocksArticlesSn)
    {
