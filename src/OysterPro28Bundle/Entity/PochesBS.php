 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="OysterPro28Bundle\Repository\PochesBSRepository")
 */
class PochesBS
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="OysterPro28Bundle\Entity\StocksPochesBS", mappedBy="pochesbs",cascade={"persist","remove"})
     */
    private $stockspoches;
    /**
     * @ORM\ManyToOne(targetEntity="OysterPro28Bundle\Entity\Magasins",inversedBy="poches")
     ...
     * Add stockspoches
     *
     * @param \OysterPro28Bundle\Entity\StocksPochesBS $stockspoches
     * @return PochesBS
     */
    public function addStockspoch(\OysterPro28Bundle\Entity\StocksPochesBS $stockspoches)
    {
     ...
     * @param \OysterPro28Bundle\Entity\StocksPochesBS $stockspoches
     */
    public function removeStockspoch(\OysterPro28Bundle\Entity\StocksPochesBS $stockspoches)
    {
