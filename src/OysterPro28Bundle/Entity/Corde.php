 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="OysterPro28Bundle\Repository\CordeRepository")
 */
class Corde
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="OysterPro28Bundle\Entity\StocksCordes", mappedBy="corde",cascade={"persist","remove"})
     */
    private $stockscordes;
    /**
     * @ORM\ManyToOne(targetEntity="OysterPro28Bundle\Entity\Magasins",inversedBy="cordes")
     ...
     * Add stockscordes
     *
     * @param \OysterPro28Bundle\Entity\StocksCordes $stockscordes
     * @return Corde
     */
    public function addStockscorde(\OysterPro28Bundle\Entity\StocksCordes $stockscordes)
    {
     ...
     * @param \OysterPro28Bundle\Entity\StocksCordes $stockscordes
     */
    public function removeStockscorde(\OysterPro28Bundle\Entity\StocksCordes $stockscordes)
    {
