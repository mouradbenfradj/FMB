...
class DocumentsTypes
{
    ...
    /**
     * @var \OysterPro28Bundle\Entity\PdfModeles
     *
     * @ORM\ManyToOne(targetEntity="OysterPro28Bundle\Entity\PdfModeles")
     * @ORM\JoinColumns({
     ...
     * Set idPdfModele
     *
     * @param \OysterPro28Bundle\Entity\PdfModeles $idPdfModele
     * @return DocumentsTypes
     */
    public function setIdPdfModele(\OysterPro28Bundle\Entity\PdfModeles $idPdfModele = null)
    {
     ...
     * Get idPdfModele
     *
     * @return \OysterPro28Bundle\Entity\PdfModeles
     */
