...
use App\Form\StocksLanternesType;

/**
 * StocksLanternes controller.
 *
 */
class StocksLanternesController  extends AbstractController
{
    public function dateLanternePreparer()
    {// Get the province ID
    ...
    public function articleLanternePreparer()
    {// Get the province ID
        $id = $request->query->get('lanterne');
        $em = $this->getDoctrine()->getManager();
        $implementation = new DefaultImpl($em);
