...
class FiliereController  extends AbstractController
{
    ...
    public function findByParcAction(Magasins $parc, $page)
    {
        ...
        return $this->render('Filiere/Render/listFiliereIndexRender.html.twig', array('filieres' => $filieres, 'page' => $page));
    }
    ...
    public function observationAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('Filiere/Include/listObservationFiliere.html.twig', array(
