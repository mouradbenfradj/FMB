...
namespace App\Controller\Menu\Retrait;
...
class AwController  extends AbstractController
{
    public function retraitLanterne()
    {
        if ($this->container->get('security.authorization_checker')->isGranted('ROLE_SUPER_ADMIN')) {
            ...
            return $this->render('Retrait/retraitLanterne.html.twig',
                array(
                    'entity' => $parcs,
                    'articles' => $articles,
                    'processus' => $processus
