...
/**
        ...
        public function previsionSortieCourbe()
    {
        ...
        return $this->render('Outil/previsionFutureCourbe.html.twig', array('parcs' => $parcs, 'choix' => $choix, 'datePrevision' => $datePrevision, 'historiquePrevision' => $tableauPrevision));
    }
