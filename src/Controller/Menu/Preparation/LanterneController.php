        ...
        if ($this->container->get('security.authorization_checker')->isGranted('ROLE_SUPER_ADMIN')) {
            ...
            if ($request->isMethod('POST')) {
                ...
                if (!empty($stockarticles)) {
                    ...
                    return $this->render('Default/preparationLanterne.html.twig', array('form' => $form->createView()));
                }
                $tacheEffectuer =
                    array(
            ...
            return $this->render('Preparation/preparationLanterne.html.twig', array('form' => $form->createView()));
        } else {
