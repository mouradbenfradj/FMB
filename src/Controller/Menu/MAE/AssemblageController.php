...
use App\Implementation\AssemblageImpl;
use Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Session\Session;


class AssemblageController  extends AbstractController
{
    public function miseAEauAssemblageFormulaire()
    {
        if ($this->container->get('security.authorization_checker')->isGranted('ROLE_SUPER_ADMIN')) {
            ...
            return $this->render(
                'MAE/Assemblage/formulaireAssemble.html.twig',
                array(
                    'entity' => $parcs,
                    'articles' => $articles,
    ...
    public function miseAEauAssemblage()
    {
        if ($this->container->get('security.authorization_checker')->isGranted('ROLE_SUPER_ADMIN')) {
            $em = $this->getDoctrine()->getManager();
            $session = new Session();
            ...
            return $this->render(
                'MAE/Assemblage/miseAEauAssemble.html.twig',
                array(
                    'entity' => $parcs,
                    'assemblages' => $formulaire,
                    'processus' => $processus,
